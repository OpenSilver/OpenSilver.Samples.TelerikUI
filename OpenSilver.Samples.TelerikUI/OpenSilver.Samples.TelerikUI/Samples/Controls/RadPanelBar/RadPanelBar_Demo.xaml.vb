...
Namespace OpenSilver.Samples.TelerikUI
    Public Partial Class RadPanelBar_Demo
        ...
        .FilePathOnGitHub = "github/OpenSilver/OpenSilver.Samples.TelerikUI/blob/master/OpenSilver.Samples.TelerikUI/OpenSilver.Samples.TelerikUI/Samples/Controls/RadPanelBar/RadPanelBar_Demo.xaml"
         ...
         .FilePathOnGitHub = "github/OpenSilver/OpenSilver.Samples.TelerikUI/blob/master/OpenSilver.Samples.TelerikUI/OpenSilver.Samples.TelerikUI/Samples/Controls/RadPanelBar/RadPanelBar_Demo.xaml.vb"
    }
})
        End Sub
    End Class
