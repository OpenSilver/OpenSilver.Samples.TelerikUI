...
{
    internal sealed class UserDataPoint
    {
    ...
    {
        private static readonly double[,] constsY = new double[3, 12]
        {
        ...
        private static readonly double[,] constsRange = new double[2, 12]
        {
            { 24, 9, 18, 31, 25, 13, 17, 33, 21, 28, 19, 11 },
            { 17, 6, 12, 22, 20, 8, 13, 28, 18, 19, 18, 7 }
        };

        private static readonly double[,] constsFinancial = new double[4, 7]
        {
        ...
        {
            Random random = new Random((int)(series.GetHashCode() + DateTime.Now.Ticks % 10000));
        ...
        public static void FillWithSampleFinancialData(DataSeries series, int numberOfItems, int numberOfPeaks)
        {
            ...
            random = new Random((int)(series.GetHashCode() + DateTime.Now.Ticks % 10000));
