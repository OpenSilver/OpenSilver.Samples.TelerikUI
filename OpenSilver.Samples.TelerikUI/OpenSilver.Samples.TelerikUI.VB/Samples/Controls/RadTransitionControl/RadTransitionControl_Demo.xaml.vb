...
Namespace Global.OpenSilver.Samples.TelerikUI
    Public Partial Class RadTransitionControl_Demo
        ...
        .FilePathOnGitHub = "github/OpenSilver/OpenSilver.Samples.TelerikUI/blob/master/OpenSilver.Samples.TelerikUI/OpenSilver.Samples.TelerikUI/Samples/Controls/RadTransitionControl/RadTransitionControl_Demo.xaml"
         ...
         .FilePathOnGitHub = "github/OpenSilver/OpenSilver.Samples.TelerikUI/blob/master/OpenSilver.Samples.TelerikUI/OpenSilver.Samples.TelerikUI.VB/Samples/Controls/RadTransitionControl/RadTransitionControl_Demo.xaml.vb"
    }
})
        End Sub
    End Class
