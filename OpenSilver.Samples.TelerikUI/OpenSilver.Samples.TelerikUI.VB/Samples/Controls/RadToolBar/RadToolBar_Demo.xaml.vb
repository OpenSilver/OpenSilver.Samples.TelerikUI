...
Namespace Global.OpenSilver.Samples.TelerikUI
    Public Partial Class RadToolBar_Demo
        ...
        .FilePathOnGitHub = "github/OpenSilver/OpenSilver.Samples.TelerikUI/blob/master/OpenSilver.Samples.TelerikUI/OpenSilver.Samples.TelerikUI/Samples/Controls/RadToolBar/RadToolBar_Demo.xaml"
         ...
         .FilePathOnGitHub = "github/OpenSilver/OpenSilver.Samples.TelerikUI/blob/master/OpenSilver.Samples.TelerikUI/OpenSilver.Samples.TelerikUI.VB/Samples/Controls/RadToolBar/RadToolBar_Demo.xaml.vb"
    }
})
        End Sub
    End Class
