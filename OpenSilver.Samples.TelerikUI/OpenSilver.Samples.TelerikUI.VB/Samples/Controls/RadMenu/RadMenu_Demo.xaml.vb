...
Namespace Global.OpenSilver.Samples.TelerikUI
    Public Partial Class RadMenu_Demo
        ...
        .FilePathOnGitHub = "github/OpenSilver/OpenSilver.Samples.TelerikUI/blob/master/OpenSilver.Samples.TelerikUI/OpenSilver.Samples.TelerikUI/Samples/Controls/RadMenu/RadMenu_Demo.xaml"
         ...
         .FilePathOnGitHub = "github/OpenSilver/OpenSilver.Samples.TelerikUI/blob/master/OpenSilver.Samples.TelerikUI/OpenSilver.Samples.TelerikUI.VB/Samples/Controls/RadMenu/RadMenu_Demo.xaml.vb"
    }
})
        End Sub
    End Class
