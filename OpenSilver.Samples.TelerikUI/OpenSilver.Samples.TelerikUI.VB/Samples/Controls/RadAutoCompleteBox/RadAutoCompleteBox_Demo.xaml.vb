...
Namespace Global.OpenSilver.Samples.TelerikUI
    Public Partial Class RadAutoCompleteBox_Demo
        ...
        .FilePathOnGitHub = "github/OpenSilver/OpenSilver.Samples.TelerikUI/blob/master/OpenSilver.Samples.TelerikUI/OpenSilver.Samples.TelerikUI/Samples/Controls/RadAutoCompleteBox/RadAutoCompleteBox_Demo.xaml"
         ...
         .FilePathOnGitHub = "github/OpenSilver/OpenSilver.Samples.TelerikUI/blob/master/OpenSilver.Samples.TelerikUI/OpenSilver.Samples.TelerikUI.VB/Samples/Controls/RadAutoCompleteBox/RadAutoCompleteBox_Demo.xaml.vb"
    }
})
        End Sub
    End Class
